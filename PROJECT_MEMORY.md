...
| `m7a-public-contract` | The deterministic M7A manifest inventories 144 root exports, 25 serializable public result types, four console scripts, 12 schema files, semantic axes forms, and the stable coded error family. `make check` fails on unreviewed drift; golden serialized variants remain M7C work. | `docs/PUBLIC_CONTRACT_INVENTORY.md`; `docs/m7/public-contract.json`; `tools/public_contract.py`; `tests/test_repository_policy.py` | 2026-09-15 |
