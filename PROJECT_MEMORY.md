...
| `m6a-method-approval` | Joshua Myers approved M6A ADR-005, ADR-006, and R1–R3/G6 without revision: fixed 20% trimmed/Winsorized robust methods, explicit seeded percentile correlation intervals, Yuen/Welch–Yuen and repeated comparisons, raw effects, Holm families, native bounded formulas, owned RNG/work limits, and no fallback. The implementation was later accepted; R4, B1–B6, and later-track acceptance gates remain pending. | `docs/M6_STATISTICAL_METHODS.md`; `docs/adr/ADR-005-robust-method-architecture.md`; `docs/adr/ADR-006-bayesian-engine-architecture.md`; `docs/evidence/M6A_SIGNOFF.md` | 2026-09-14 |
