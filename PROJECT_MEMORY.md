...
| `m3-contract` | M3 is a planned 5–7 week comparison milestone split into M3A independent groups plus `0.1` composition/theme closure and M3B repeated measurements for `0.2`; M3 is complete only after both tracks pass and Joshua Myers approves their methods and release candidates. | `docs/MILESTONE_3.md`; `docs/PROJECT_PLAN.md` | 2026-09-14 |
