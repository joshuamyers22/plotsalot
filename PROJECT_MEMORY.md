...
| `m7-entry-proposal` | M7 proposes stabilizing the existing adapted surface for all 22 upstream exports without requiring new statistical families for 1.0, a locked robust-meta boundary experiment, and an explicit 1.x API/schema policy. M7-D1 through M7-D3 and independent-review ownership remain pending; no new calibration run or implementation is authorized by the draft alone. | `docs/MILESTONE_7.md`; `docs/m7/compatibility-disposition.json`; `docs/M7_CALIBRATION_PLAN.md`; `docs/adr/ADR-007-public-api-schema-stability.md` | 2026-09-15 |
