...
| `m7d-release-candidate` | The 1.0.0 technical candidate has self-cleaning builds, machine-checked wheel/sdist contents and metadata, and offline installed-artifact smoke coverage on Python 3.11 and 3.12. The full check, audit, oracle, benchmark, build, and release-tag gates pass. Final owner acceptance, tagging, protected publication approval, and post-publication verification remain separate actions. | `docs/evidence/M7D_RELEASE_VERIFICATION.md`; `tools/verify_artifacts.py`; `tools/smoke_installed.py`; `.github/workflows/ci.yml`; `.github/workflows/release.yml` | 2026-09-15 |
