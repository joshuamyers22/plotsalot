...
| `first-pypi-version` | The first PyPI release candidate is `0.1.1`; it follows the existing, materially different `v0.1.0` GitHub release rather than adopting the internal `0.4` product-gate label. | `pyproject.toml`; `CHANGELOG.md`; `docs/PROJECT_PLAN.md` | 2026-09-15 |
