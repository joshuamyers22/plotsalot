...
| `m7b-calibration-harness` | M7B v1 mapping (76,000 fits) and confirmation (40,000 fits) are sealed and digest-chained. The mapping retained one `robust_meta_ambiguous_optimum` failure at `k=10, tau=0.025`, blocking reaffirmation; neither run had an undercoverage flag. Confirmation had no failures and conservatively flagged four focal cells. Independent review and the owner's replace/reclassify/versioned-correction disposition remain open. | `docs/evidence/M7B_MAPPING_VERIFICATION.md`; `docs/evidence/M7B_CONFIRMATION_VERIFICATION.md`; `docs/evidence/M7B_INDEPENDENT_REVIEW.md`; `docs/M7_CALIBRATION_PLAN.md` | 2026-09-15 |
