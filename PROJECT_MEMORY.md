...
| `m7c-stability` | M7C is complete. A 51-example corpus covers all 25 serialized public result types and 49 schema/discriminator triples; every example passes Draft 2020-12 validation plus field/type/version/discriminator/unknown-property mutations. Pre-1.0 schema gaps for grouped robust, composition limits, and Bayesian properties were corrected without changing emitted payloads. M7D release closeout remains. | `docs/m7/golden-results.json`; `tests/test_m7c_stability.py`; `docs/evidence/M7C_VERIFICATION.md` | 2026-09-15 |
