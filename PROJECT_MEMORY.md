...
| `m7a-public-contract` | Joshua Myers accepted M7A pass 2 on 2026-09-15. All 144 root exports are retained for 1.x stabilization across ten contract categories without removals or renames. The deterministic manifest/reference and compatibility prose fail checks on drift; M7C golden variants remain open. | `docs/PUBLIC_API_REFERENCE.md`; `docs/MIGRATING_TO_1_0.md`; `docs/m7/public-contract.json`; `docs/evidence/M7A_PASS2_VERIFICATION.md` | 2026-09-15 |
| `m7b-calibration-harness` | The approved M7B v1 driver fixes 38 mapping cells/76,000 fits and eight confirmation cells/40,000 fits with identity-derived PCG64DXSM streams, failure-inclusive denominators, clean-tree/no-overwrite controls, SHA-256 sealing, and a 5 MiB artifact ceiling. The mapping retained one `robust_meta_ambiguous_optimum` failure at `k=10, tau=0.025`, which blocks reaffirmation; no cell had a predeclared undercoverage flag. Confirmation and the owner's replace/reclassify disposition remain open. | `tools/calibrate_m7b.py`; `docs/evidence/m7b-robust-meta-mapping.json`; `docs/evidence/M7B_MAPPING_VERIFICATION.md`; `docs/M7_CALIBRATION_PLAN.md` | 2026-09-15 |
