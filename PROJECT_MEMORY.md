...
| `m4-contract` | M4 is a 3–4 week categorical milestone covering raw and aggregate counts, one-way/independent/paired classical designs, a shared result for bar and pie renderers, pairwise/stratum families, grouped variants, and the final `0.2` gate. The technical release candidate is ready; independent review and final acceptance remain. | `docs/MILESTONE_4.md`; `docs/PROJECT_PLAN.md` | 2026-09-14 |
...
| `m4-release-candidate` | M4 categorical tables, shared inference, bar/pie renderers, grouped variants, schemas, tests, pinned-R fixtures, and benchmark tooling are implemented; production verification, independent review, and final owner acceptance remain blocking. | `docs/MILESTONE_4.md`; `docs/evidence/M4_SIGNOFF.md` | 2026-09-14 |
