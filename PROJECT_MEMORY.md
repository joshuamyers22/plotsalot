...
| `m5b-implementation` | The M5B technical candidate is implemented and independently accepted by Joshua Myers: strict owned study-effect tables, REML/Hartung–Knapp analysis, versioned results, semantic rendering, composition, independent likelihood/analytic tests, pinned-R/base-R/metafor oracle evidence, and a retained study-count benchmark. M5A sharing and final M5/`0.3` acceptance remain open. | `docs/evidence/M5B_VERIFICATION.md`; `docs/evidence/M5B_SIGNOFF.md` | 2026-09-14 |
