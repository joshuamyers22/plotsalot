...
- Status: K1–K4 approved; MA1–MA4 pending
- Version: 0.1.0
- Date: 2026-09-14
- Statistical owner/reviewer: Joshua Myers
- Applies now to: M5A coefficient tables, fitted OLS adaptation, and
  dot-and-whisker rendering
- Reserved for M5B: MA1–MA4 frequentist meta-analysis decisions
...
- MA1–MA4 meta-analysis until a separate M5B proposal is approved;
