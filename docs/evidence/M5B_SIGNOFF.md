# M5B Accountable Sign-off

The M5B contract cannot be completed by technical verification alone. Joshua
Myers is the recorded statistical and product owner.

| Decision | Role | Approver | Decision/date | Status |
|---|---|---|---|---|
| MA1 study estimand, scale, independence, and input contract | Statistical-methods reviewer | Joshua Myers | Approved, 2026-09-14 | Complete |
