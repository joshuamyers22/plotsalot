...
| Public API manifest | Generated/retained names and signatures compared in CI with reviewed exceptions | M7A pass 1 technical gate passed; independent review pending |
